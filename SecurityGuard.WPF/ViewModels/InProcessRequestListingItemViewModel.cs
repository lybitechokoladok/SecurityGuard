...
{
    public class InProcessRequestListingItemViewModel
    {
        ...
        public ICommand EndRequestCommand { get; }
        public InProcessRequestListingItemViewModel(Request request, ICommand endRequestCommand)
        {
            Request = request;
            EndRequestCommand = endRequestCommand;
        }
    }
}
